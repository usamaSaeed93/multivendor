    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-content-wrapper">
            <div class="auth-content">
                <div class="d-flex justify-content-between align-items-center" style="padding: 40px 40px 0 40px">
                ...
                <div class="flex-grow-1 d-flex flex-column justify-content-center" style="padding: 32px 60px">
                    ...
                    <div class="mt-4">
                        ...
                        <FormInput v-model="email" :errors="errors" :label="$t('email_address')"
                            :disabled="email_disabled" name="email" required type="email">
                            <template #prefix>
                        ...
                        <div class="mt-4 d-grid">
                            <LoadingButton :loading="loading" class="px-2-5 fw-medium py-1-5" color="bluish-purple"
                                flexed-icon icon="outgoing_mail" icon-size="20" @click="sendEmail">
